...
int main(){
	...
	while(procstatus)
	{
		...
		fp=fopen("/home/ANUBHAV/Desktop/2019201014_assignment_1/history.txt", "a+"); 
		if (fp == NULL) 
	    { 
        ...
        if(histlinecount>=histmaxsize){//changing history deleting first elemnt
	        		//cout<<"here"<<endl;
	        		 string line;
				    ifstream in("/home/ANUBHAV/Desktop/2019201014_assignment_1/history.txt");
				    if(!in.is_open())
				    {
				          cout << "Input file failed to open\n";
				          return 1;
				    }
				    ofstream out("/home/ANUBHAV/Desktop/2019201014_assignment_1/outfile.txt");
				    	getline(in,line);
				    ...
				    in.close();
				    out.close();    
				    remove("/home/ANUBHAV/Desktop/2019201014_assignment_1/history.txt");
				    rename("/home/ANUBHAV/Desktop/2019201014_assignment_1/outfile.txt","/home/shanu/Desktop/2019201014_assignment_1/history.txt");
	        	}
...
{//open applications
	if(strncmp(arr,"open",4)==0) 
		...
		if(strcmp(arr,"history")==0) //+i to show history
     	{
     		fp=fopen("/home/ANUBHAV/Desktop/2019201014_assignment_1/history.txt", "r"); 
			if (fp == NULL) 
		    { 
		        printf("Couldn't open file"); 
		    } 
	  	...
	  	if(recordstatus==1){
				...
				if ( strcmp(args3[0], "cd")!=0 ){
				  ...
				  switch (pid = fork()) {
			        case 0:
			                int fd2;
			                if ((fd2 = open("/home/ANUBHAV/Desktop/2019201014_assignment_1/Records.txt", O_WRONLY| O_APPEND | O_CREAT, 0644)) < 0) {
			                    perror("output file error");
			                    exit(0);
			                }
			                dup2(fd2, STDOUT_FILENO);
